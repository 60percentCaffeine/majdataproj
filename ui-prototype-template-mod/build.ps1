...
$CoreProject = Join-Path $PSScriptRoot "src\UiPrototypeTemplateMod.Core\UiPrototypeTemplateMod.Core.csproj"
$CoreOutput = Join-Path $PSScriptRoot "src\UiPrototypeTemplateMod.Core\bin\Release\netstandard2.0\UiPrototypeTemplateMod.Core.dll"
...
Copy-Item -Force $CoreOutput (Join-Path $OutputDir "UiPrototypeTemplateMod.Core.dll")
Write-Host "Copied UiPrototypeTemplateMod.Core.dll to $OutputDir"
